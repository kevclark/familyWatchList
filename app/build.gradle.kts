...
android {
    ...
    defaultConfig {
        ...
        // NOTE (2026-08-23): this slipped for a few builds after M8 shipped - alpha.1 covered
        // everything up through the M8 rotation fix. Bumping now and actually keeping to the
